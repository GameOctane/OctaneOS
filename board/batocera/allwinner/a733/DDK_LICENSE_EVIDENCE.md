...
## Git Commit Recording Inclusion

The DDK was added to OctaneOS in commit `a3a6c84`:

```
feat: bake PowerVR DDK into image and re-enable xpad LEDs

Bundle Radxa a733-bullseye xserver-xorg-img-bxm DDK v24.2.6603887
(Section: free, Maintainer: Allwinnertech) directly into the fsoverlay.
```

Date: Tue Jun 23 22:33:57 2026 -0700
